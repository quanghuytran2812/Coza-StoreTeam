<%-- 
    ...
    Created on : Mar 15, 2022, 5:56:03 PM
    Author     : tuan anh
--%>
                        ...
                        <table class="table-shopping-cart">
                            ...
                            <c:forEach items="${sessionScope.cart}" var="map" >
                                <tr class="table_row">
                                    ...
                                    <td class="column-3">${map.value.product.getDisPrice() }</td>
                                    <td class="column-4">
                                        <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                            ...
                                            <input class="mtext-104 cl3 txt-center num-product" type="number" name="num-product1" value="${map.value.iquantity }">
                                    ...
                                    <td class="column-5">$ ${map.value.product.getDisPrice() * map.value.iquantity }</td>
                                </tr>
                            </c:forEach>
                ...
                <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                    ...
                    <div class="flex-w flex-t p-t-27 p-b-33">
                        ...
                        <div class="size-209 p-t-1">
                            ...
                            <a href="${pageContext.request.contextPath}/member/order" class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer">
                        Proceed to Checkout
                    </a>
                </div>
            </div>
