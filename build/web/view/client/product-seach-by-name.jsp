<%-- 
    ...
    Created on : Mar 20, 2022, 12:15:56 AM
    Author     : tuan anh
--%>
...
<section class="bg0 p-t-23 p-b-130">
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                ...
                <c:forEach items="${cateList}" var="cl" >
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" data-filter=".${cl.cname}">
                        ${cl.cname}
                    </button>
                </c:forEach>
            </div>
        ...
        <div class="row isotope-grid">
            <c:forEach items="${productSeachByName}" var="pw" >
