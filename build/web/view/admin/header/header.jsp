<%-- 
    Document   : header
    Created on : Mar 2, 2022, 12:06:38 PM
    Author     : tuan anh
--%>
...
<html>
    <head>
        ...
        <link rel="icon" href="${url}/images/logo-admin.png" type="image/x-icon">
                    ...
                    <ul class="navbar-nav align-items-center right-nav-link">
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                    ...
                                    <a href="javaScript:void();">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h6 class="mt-2 user-title">Coza Store</h6>
                                                <b> Admin: ${sessionScope.account.usname} </b>                         
                                            </div>
                                        </div>
                                    </a>
                                </li>
                                ...
                                <li class="dropdown-item"><i class="icon-power mr-2"></i><a href="${pageContext.request.contextPath}/logout"> Logout</a></li>		
                            </ul>
                        </li>
                    </ul>
                </nav>
