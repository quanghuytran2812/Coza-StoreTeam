    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (FileItem item : items) {
                ...
                } else if (item.getFieldName().equals("pcate")) {
            ...
            System.out.println(pid + " | " +name + " | " + cid + " | " + price + " | " + discount + " | " + description + " | " + isnew + " | " + img + ": Controller admin edit product");
            System.out.println( product + ": Controller admin edit product");
