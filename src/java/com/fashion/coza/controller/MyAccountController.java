...
public class MyAccountController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/view/client/myAccount.jsp").forward(request, response);
        ...
        try {
            ...
            for (FileItem item : items) {
                ...
                if (item.getFieldName().equals("uid")) {
                    ...
                    role = item.getString();
                    user.setUrole(Boolean.parseBoolean(item.getString()));
                }

            }

            System.out.println(id + "|" + email + "|" + uname + "|" + pass + "|" + role + "|| do post my account");
...
//
            ...
            response.sendRedirect(request.getContextPath() + "/member/myaccount");
            System.out.println(id + "|" + email + "|" + uname + "|" + pass + "|" + role);
        }
