<%-- 
    Document   : blog
    Created on : Jan 28, 2022, 4:13:00 PM
    Author     : tuan anh
--%>
        ...
        <div class="row">
                ...
                <div class="blog-item">
                    <div class="hov-img0">
                        <a href="blog-detail.html">
                            <img src="${url}/images/blog-01.jpg" alt="IMG-BLOG">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-40">
                <div class="blog-item">
                    <div class="hov-img0">
                        <a href="blog-detail.html">
                            <img src="${url}/images/blog-02.jpg" alt="IMG-BLOG">
                        </a>
                    </div>
            ...
            <div class="col-sm-6 col-md-4 p-b-40">
                <div class="blog-item">
                    <div class="hov-img0">
                        <a href="blog-detail.html">
                            <img src="${url}/images/blog-03.jpg" alt="IMG-BLOG">
                        </a>
                    </div>
